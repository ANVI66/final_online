...
$numericPortion = intval(substr($lastBatchNumber, 4)) + 1;
return 'BI-' . str_pad($numericPortion, 5, '0', STR_PAD_LEFT);
} else {
return 'BI-0001'; // Start with EP0001 if no previous records
}
}
...
<div class="authorization_footer_if">
        <?php  require_once "acsincludes/footer.php";?>
    </div>
