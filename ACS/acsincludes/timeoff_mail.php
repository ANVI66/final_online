...
if (isset($_POST['request_leave'])) {
    ...
    if (mysqli_query($conn, $sql)) {
        ...
        $approveLink = 'https://acsteck.online/approve_leave.php?id=' . mysqli_insert_id($conn); // Replace with your actual approve script URL
        $rejectLink = 'https://acsteck.online/reject_leave.php?id=' . mysqli_insert_id($conn); // Replace with your actual reject script URL
