...
<head>
    ...
    <link rel="stylesheet" href="css/styles.css">
       <link rel="stylesheet" href="css/trainee_empsave.css">
                ...
                <tbody>
                    ...
                    ?>
                        ...
                        <!-- <td><php echo $id1 ?></td> -->
                            ...
                            <a href="traineedelete.php?id=<?php echo $row["ID"]; ?>" i class="fa fa-trash" aria-hidden="true" onclick='return checkdelete()'></i></a></td>
                        </tr>
                    <?php } ?>
                </tbody>
            </table>
