                ...
                if (isset($_GET['project_id'])) {
                    ...
                    if (mysqli_num_rows($result_employee_production) > 0) {
                        ...
                        while ($row = mysqli_fetch_assoc($result_employee_production)) {
                            ...
                            $pending = $totalpages - $completed;
                        }

                        // Display total values for the department
                        echo '<tr>';
                        echo '<td colspan="3">TOTAL PAGES: ' . $totalpages . '</td>';
                        echo '<td colspan="3">TOTAL COMPLETED: ' . $completed . '</td>';
                        echo '<td colspan="1">TOTAL PENDING: ' . $pending . '</td>';
                        echo '</tr>';
