...
<head>
    ...
    <link rel="stylesheet" href="css/stylesss.css">
     <link rel="stylesheet" href="css/trainee_salaryy.css">
...
a.link-with-spacing:hover {
    text-decoration: none;
}
a{text-decoration: none;}

.view_salaryy{background-color:white;}
...
<div class="col-md-9">
    ...
    <div class="acnt-view">
                            ...
                            <button type="submit2" class="btn btn-link view_salaryy"><a href="trainee_salary_view.php" class="link-with-spacing">View salary details</a></button>
                            </div>
                        ...
                        <div class="row">
                            <div class="col-md-12">
                                ...
                                if (isset($_GET['stud_id'])) {
                                    ...
                                    $employee_query = "SELECT * FROM employee_data WHERE (CODE LIKE '$stud_id%' OR NAME LIKE '$stud_id%') AND STATUS != 'exit'";
                                    ...
                                    if (mysqli_num_rows($employee_result) > 0) {
                                        ...
                                        while ($employee_row = mysqli_fetch_assoc($employee_result)) {
                                            ...
                                            ?>                          
                                                                                <form action="trainee_salary_db.php" id="salary_details" method="post">
                                               <TABLE>
                                                <TR>
                                                    <TD>
...
<td>
    ...
    <input type="text" id="Basic" name="Basic" value="" class="form-control"  required readonly>
                                        </div>
                                        </td>
                                        <td>
                                        <div class="form-group mb-3">
...
<label for="">Gross salary</label>
    <input type="text" name="bas_inc" id="bas_inc" value="<?= $employee_row['BASIC']; ?>" class="form-control" readonly required>
                                               ...
                                               <div class="form-group mb-3">
                                                ...
                                                <div class="form-group mb-3">
                                                    <label for="">Total salary</label>
                                                    <input type="text" id="final_salary_fixed" value="0" name="final_salary_fixed" class="form-control" readonly>
                                                </div>
                                            ...
                                            <input name="esi_epf_value"  value ="No" id="esi_epf" class="form-control" readonly required>
...
<script src="https://code.jquery.com/jquery-3.6.0.min.js"></script>
<script src ="js/trainee_salary.js"></script>
