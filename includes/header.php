        ...
        <div class="offcanvas-body">
            <ul class="navbar-nav justify-content-end flex-grow-1 pe-3">
                ...
                <li><hr class="dropdown-divider"></li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <?php if ($user_position == "Human Resource Manager" || $user_position == "Admin") { ?>
                            <li><a class="dropdown-item" href="payslip.php">EMPLOYEE</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="trainee.php">TRAINEE</a></li>
                        <?php } else { ?>
                ...
                <li><hr class="dropdown-divider"></li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <?php if ($user_position == "General Manager" || $user_position == "Human Resource Manager") { ?>
                            <li><a class="dropdown-item" href="salary_days_count.php">EMPLOYEE</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="trainee_salary_count.php">TRAINEE</a></li>
                        <?php } else { ?>
                            <li><p class="dropdown-item">Authorization Blocked by Admin</p></li>
                        <?php } ?>
                    </ul>
                ...
                <li><hr class="dropdown-divider"></li>
                    ...
                    <ul class="dropdown-menu dropdown-menu-dark">
                        <?php if ($user_position == "General Manager" || $user_position == "Human Resource Manager" || $user_position == "Admin") { ?>
                            <li><a class="dropdown-item" href="emp_payslip.php">EMPLOYEE</a></li>
                            <li><hr class="dropdown-divider"></li>
                            <li><a class="dropdown-item" href="trainee_payslip.php">TRAINEE</a></li>
                        <?php } else { ?>
                            <li><p class="dropdown-item">Authorization Blocked by Admin</p></li>
                        <?php } ?>
                    </ul>
