...
if (isset($_POST['filter'])) {
    ...
    // Fetch all data if the filter is not applied
    $query = "SELECT * FROM `salary_data` WHERE sCODE LIKE 'TR%'";
}
...
<head>
    ...
    <link rel="stylesheet" href="css/trainee_salary_view.css"/>
...
<div class="salary_view">
    ...
    $edit = '<a href="trainee_view_edit.php?id=' . $row["ID"] . '" class="btn_edit_salary_view" role="button">Update</a>';
} ?>
<tr>
